...
class StudentDetail(http.Controller):
    ...
    def render_example_page(self,data="All"):
      return http.request.render('new_app.hello_world_page', {'data' : data})
    ...
    def student_page(self,**kw):
        ...
        return http.request.render('new_app.student_registration_page')
        # return http.Response(f'<title> Hello World </title> <h1>Hello World {data} 🙂😎🙂!!! </h1> ')
    ...
    def home_page(self):
        ...
        return http.request.render('new_app.homePage',{'st_user': st_rec })
    ...
    def student(self, student_id, **kw):
      ...
      return http.request.render('new_app.student_portal_template',values)
    ...
    def course(self, course_id, **kw):
      ...
      return http.request.render('new_app.course_portal_template',values)
    ...
    def login_page(self,**kw):
        ...
        return http.request.render('new_app.student_login_page',{'alert_msg':alert_msg})
    ...
    def v_profile_page(self):
        ...
        st_id = request.session.s_uid
        st_rec = request.env['school.student.detail'].sudo().browse([st_id])  
        return http.request.render('new_app.student_vprofile_page',{'student_dt':student_profile_rec,'st_user': st_rec})      
    ...
    def add_student(self,redirect=None,**post):
        ...
        print("get request...")    
        return http.request.render('new_app.portal_add_student')      
